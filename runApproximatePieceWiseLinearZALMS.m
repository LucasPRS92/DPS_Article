function [ MSD ] = runApproximatePieceWiseLinearZALMS( w0 , numberOfIterations , sigmanu2 , beta , kappa , a , b , t , numberOfRepeats )
...
for repeat = 1 : numberOfRepeats
    ...
    for k = N : numberOfIterations + N - 1
        ...
        wk = wk + beta * xk * ek + kappa * evaluatePiecewiseLinearFunction( wk , a , b , t );
